...
<body class="cbp-spmenu-push">
    ...
    <div class="main-content">
        ...
        <!-- //header-ends -->
        <!-- main content start-->
        <div id="page-wrapper" style="min-height: 1203px; background-image: url(https://t3.ftcdn.net/jpg/01/98/81/40/360_F_198814073_1Ou5wprYWhldGzS6AWzPuSvx4L9E2TEt.jpg);background-size: cover;">

  <%
Connection con=DbConnection.connect();
PreparedStatement pstmt=con.prepareStatement("select * from pharmalogin where status=\"Not Approved\" ");
 ...
 <tr>
     ...
     <td><%= rs.getString(8) %></td>
       <td><%= rs.getString(4) %></td>
         ...
         <td> <a href="approve.jsp?id=<%= i %>">Approved</a></td>
 </tr>
<% } %>
</table>
</center>
